...
/**
 * Created by kleist on 14-1-5.
 */
public class DongxiSimilarsTask extends SimpleVolleyTask<List<Dongxi>> {
    ...
    public DongxiSimilarsTask(Context context, String id, VolleyTaskCallBack<List<Dongxi>> callBack) {
    ...
    protected List<Dongxi> onResponse(JSONObject json) throws Throwable {
        String shows = json.getJSONArray("similars").toString();
